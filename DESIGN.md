...
3. **The accent is never decorative.** Focus rings, the primary button, and a live state
   badge. Nothing else.
4. **Surface lift means selected**, not emphasis. Don't lift to decorate.
...
| `surface-2` | `#181824` | Selected row, hovered card |
...
Spacing: `4 · 8 · 12 · 16 · 24 · 32`. Nothing else. Page gutter 24. Card padding 14.
Gap between rows in a list 6.

## Components

- **button-primary** — `accent` fill, `#FFFFFF` text, radius 6, padding 8×14. One per screen.
- **button-secondary** — `surface-1` fill, `hairline` border, `ink` text, same metrics.
