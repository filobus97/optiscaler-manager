...
using UpscalerManager.Core.Input;
...
internal static class Program
{
    ...
    {
        Console.WriteLine($"Upscaler Manager {AppUpdateService.GetCurrentVersion()} — controller diagnostics");
    ...
    public static AppBuilder BuildAvaloniaApp()
    {
        ...
        builder = underWayland
            ...
            : builder.UsePlatformDetect()
                     ...
                     .With(new X11PlatformOptions { WmClass = "UpscalerManager" });
